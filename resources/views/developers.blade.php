      ...
      <div class="container">
        <div class="row gy-5 align-items-center">
          <div class="col-lg-6">
            ...
            <p class="mc-developer-version mt-4 mb-0">Current source contract: ModernCommerce 2.1.8 · Moodle 5.2 · PHP 8.3+</p>
          </div>
...
$observers = [
    ...
    <section class="pb-5" aria-label="Audited platform inventory">
      <div class="container">
        ...
        <p class="small text-secondary mt-3 mb-0">Audited directly from <code>db/services.php</code>, <code>classes/event</code>, <code>db/tasks.php</code>, <code>db/access.php</code>, and <code>db/install.xml</code> in release 2.1.8.</p>
      </div>
    </section>

      ...
      <div class="container">
        <div class="row gy-5">
          ...
          <div class="col-lg-7"><div class="mc-open-status-list">
            ...
            <div><span class="mc-status yes">Repository available</span><strong>Public repository and issue tracker</strong><p>Review the source in the <a href="https://github.com/adebareshowemimo/moderncommerce.dev">ModernCommerce GitHub repository</a> or <a href="https://github.com/adebareshowemimo/moderncommerce.dev/issues">report an issue</a>. A security policy, contribution guide, and code of conduct will be published before the project invites public code contributions.</p></div>
          </div></div>
        </div>
      </div>
    </section>
    ...
    <section class="mc-section mc-faq-section">
      <div class="container"><div class="row gy-5">
        ...
        <div class="col-lg-8"><div class="accordion mc-faq" id="openSourceFaq">
          ...
          <div class="accordion-item"><h3 class="accordion-header"><button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#osFaqFive" aria-expanded="false" aria-controls="osFaqFive">Where is the public source repository?</button></h3><div id="osFaqFive" class="accordion-collapse collapse" data-bs-parent="#openSourceFaq"><div class="accordion-body">The source is available in the <a href="https://github.com/adebareshowemimo/moderncommerce.dev">ModernCommerce GitHub repository</a>. Use the repository's <a href="https://github.com/adebareshowemimo/moderncommerce.dev/issues">issue tracker</a> to report a problem.</div></div></div>
        </div></div>
      </div></div>
    </section>

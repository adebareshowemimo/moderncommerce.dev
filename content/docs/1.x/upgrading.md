...
This documentation targets ModernCommerce **2.1.7**, the stable release declared in the audited `version.php` (`2026080100`). That release declares Moodle **5.2 only** in its supported range and requires the Moodle 5.2 build `2026042000` or later. Composer requires **PHP 8.3 or later**.

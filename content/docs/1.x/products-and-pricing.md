...
Inventory is optional. Use **stock management** when access should be limited by seats, licences, or cohort capacity. Leave stock **unmanaged** for normal, always-available course products, which are the common case.
...
Use the advanced course features page to enrich a course's public detail page with level, duration, language, outcomes, outline, tags, and trust signals without editing Moodle course internals.

...
This is the consolidated feature inventory for **ModernCommerce 2.1.6**. It explains what each feature owns, where an administrator normally manages it, the primary Moodle capability protecting it, and the operational behavior that matters in production.
